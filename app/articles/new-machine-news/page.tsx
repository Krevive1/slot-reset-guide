...
const info = ARTICLE_CATEGORY_INFO["new-machine-news"];
...
export default function NewMachineNewsIndexPage() {
  const articles = getArticlesByCategory("new-machine-news");
